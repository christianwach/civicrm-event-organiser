...
class CiviCRM_WP_Event_Organiser_Admin {
	...
	public function include_files() {
		...
		include CIVICRM_WP_EVENT_ORGANISER_PATH . 'includes/admin/ceo-admin-settings.php';

		// Include Manual Sync Page class.
		include CIVICRM_WP_EVENT_ORGANISER_PATH . 'includes/admin/ceo-admin-manual-sync.php';

		// Maybe include Multisite Page class.
		if ( is_multisite() ) {
			include CIVICRM_WP_EVENT_ORGANISER_PATH . 'includes/admin/ceo-admin-multisite.php';
		}
